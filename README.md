...
- **Dashboard Overview**: quick account snapshot with editable stats and resource rollups.
- **Champion Tracker**: searchable Supabase-powered roster with validation, inline editing, and granular level/ascension/soul tracking backed by Supabase.
- **Resource Planner**: adjust consumables and plan future spending without leaving the dashboard.
